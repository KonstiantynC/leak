...
declare global {
  ...
  const login: typeof import('./src/composables/auth.js')['login']
  const logout: typeof import('./src/composables/auth.js')['logout']
  ...
  const register: typeof import('./src/composables/auth.js')['register']
